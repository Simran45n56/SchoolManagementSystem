    ...
    <div id="wrapper">
       ...
       <%@include file="header.jsp" %>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add new course information</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                ...
                                <div class="col-lg-9">
                                    <form role="form" action="${pageContext.request.contextPath}/admin/course/add" method="post">
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input class="form-control" name="ctitle" type="text" placeholder="Enter title here" required>
                                            <p class="help-block">Enter title in block letters.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Duration</label>
                                            <input class="form-control" type="text" name="cduration" placeholder="Enter duration here" required>
                                        </div>
                                         <div class="form-group">
                                            <label>Price</label>
                                            <input class="form-control" type="text" name="cprice" placeholder="Enter price  here" required>
                                        </div>
