    ...
    <div id="wrapper">
       ...
       <%@include file="header.jsp" %>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Update  course information</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                ...
                                <div class="col-lg-9">
                                    <form role="form" action="${pageContext.request.contextPath}/admin/course/update" method="post">
                                        <div class="form-group">
                                            <label>Id</label>
                                            <input class="form-control" name="cid" type="text" value="${course.id}" readonly required>
                                            <p class="help-block">Enter title in block letters.</p>
                                        </div>
                                           <div class="form-group">
                                            <label>Title</label>
                                            <input class="form-control" name="ctitle" type="text" value="${course.title}"  required>
                                            <p class="help-block">Enter title in block letters.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Duration</label>
                                            <input class="form-control" type="text" name="cduration" value="${course.duration}"  required>
                                        </div>
                                         <div class="form-group">
                                            <label>Price</label>
                                            <input class="form-control" type="text" name="cprice" value="${course.price}" required>
                                        </div>
